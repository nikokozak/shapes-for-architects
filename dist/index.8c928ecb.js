(function() {
    ...
    class OrbitControls extends THREE.EventDispatcher {
        constructor(object, domElement){
            ...
            this.zoomSpeed = 1; // Set to false to disable rotating
            this.enableRotate = true;
            this.rotateSpeed = 1; // Set to false to disable panning
            this.enablePan = true;
            this.panSpeed = 1;
            ...
            const pan = function() {
                ...
                return function pan(deltaX, deltaY) {
                    ...
                    if (scope.object.isPerspectiveCamera) {
                        ...
                        targetDistance *= Math.tan(scope.object.fov / 2 * Math.PI / 180); // we use only clientHeight here so aspect ratio does not distort speed
...
//# sourceMappingURL=index.8c928ecb.js.map
